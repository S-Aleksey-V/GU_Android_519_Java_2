...
public class EchoClient extends JFrame {
    ...
    public EchoClient(){
        try{
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Ошибка соединения с сервером. " + e.getMessage(),"Ощибка",JOptionPane.ERROR_MESSAGE);
        }
        prepareGUI();
    }
    ...
    public void openConnection() throws IOException {
        ...
        new Thread(() -> {
            ...
            try {
                while(true){
                    String strFormServer = in.readUTF();
                    if(strFormServer.equalsIgnoreCase(END_MESSAGE)){
                        break;
                    }
                    chatArea.append(strFormServer + "\n");
                }
            } catch (Exception e){
                JOptionPane.showMessageDialog(null,"Соединение не доступно", "Ошибка",JOptionPane.ERROR_MESSAGE);
            }
        }).start();
    }
...
public  void  sendMessage(){
        ...
        if(socket.isClosed() || out == null){
            JOptionPane.showMessageDialog(null,"Ошибка отправки сообщения. Сервер не работает", "Ошибка",JOptionPane.ERROR_MESSAGE);
            return;
        }
...
//            out.flush();
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,"Ошибка отправки сообщения. " + e.getMessage(),"Ошибка", JOptionPane.ERROR_MESSAGE);
        }
