...
public class MyServer {
    ...
    public synchronized void privateMsg(ClientHandler fromUser, String toUser, String msg) {

            if(clients.containsKey(toUser)) {
                clients.get(toUser).sendMsg("[PrivMsg from: " + fromUser.getName() + "] " + msg);

            }

        fromUser.sendMsg("[PrivMsg to: " + toUser + "] " + msg);
    }
